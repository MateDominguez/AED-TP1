...
Demostrar \{P\}S\{Q\} \\ Supongamos ciudades = [(a,10),(b,15)]
...
Paso 1 \\ $P_c \implies I ? \\ res = 0 \wedge i = 0 \implies 0 \leq i < |ciudades| \wedge res = \sum\limits_{j=0}^{i-1} ciudades[j].habitantes$
