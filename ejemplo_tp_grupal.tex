...
\begin{proc}{cantidadCaminosNSaltos}{\Inout s : \TLista{\TLista{\ent}}, \In n : \ent}{}
	...
	\asegura{(\exists t : \TLista{\TLista{\TLista{\ent}}})(|t| = n \wedge t[0] = s_0 \wedge (\forall i,j : \ent)(0 \leq i,j < |t| \implicaLuego |t[i]|=|t[j]| \yLuego esCuadrada(t[i])) \yLuego \\ (\forall i : \ent)(0 \leq i < |s_0| - 1 \implicaLuego (APorBEsC(t[i], s_0, t[i+1]))) \wedge s = t[n-1])}
\end{proc}
